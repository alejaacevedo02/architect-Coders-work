...
object UseCasesModule {
    ...
    @Provides
    fun provideRequestPopularMovieUseCase(moviesRepository: MoviesRepository) = RequestPopularMoviesUseCase(moviesRepository)

    @Provides
    fun provideFindMovieUseCase(moviesRepository: MoviesRepository) = FindMovieUseCase(moviesRepository)

    @Provides
    fun provideSwitchMovieFavoriteUseCase(moviesRepository: MoviesRepository) = SwitchMovieFavoriteUseCase(moviesRepository)
}